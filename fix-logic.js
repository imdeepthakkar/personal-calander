...
const oldLogicMatch = m.match(/const handleCopy = \(\) => \{[\s\S]*?alert\('Briefing copied to clipboard!'\);\n  \};\n/);
if (!oldLogicMatch) {
    console.error("Could not find old logic");
    process.exit(1);
}

const oldLogic = oldLogicMatch[0];
